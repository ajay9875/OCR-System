...
def insert_courses():
    with app.app_context():
        ...
        courses = [
            # ===== PRIMARY 84 COURSES (EXACTLY AS YOU SPECIFIED) =====
            ("PCC-PRI001", "HTML and CSS Fundamentals", 12, 30),
            ("PCC-PRI002", "JavaScript Programming", 14, 30),
            ("PCC-PRI003", "Responsive Web Design", 12, 30),
            ("PCC-PRI004", "Front-End Development", 16, 30),
            ("PCC-PRI005", "Back-End Development", 16, 30),
            ("PCC-PRI006", "Full-Stack Web Development", 18, 30),
            ("PCC-PRI007", "React.js Development", 14, 30),
            ("PCC-PRI008", "Node.js and Express.js", 16, 30),
            ("PCC-PRI009", "Angular Framework", 16, 30),
            ("PCC-PRI010", "Vue.js Fundamentals", 12, 30),
            ("PCC-PRI011", "Bootstrap for UI Design", 10, 30),
            ("PCC-PRI012", "Web APIs Integration", 14, 30),
            ("PCC-PRI013", "Database Management with SQL", 16, 30),
            ("PCC-PRI014", "MongoDB and NoSQL Databases", 14, 30),
            ("PCC-PRI015", "Version Control with Git", 10, 30),
            ("PCC-PRI016", "Web Hosting and Deployment", 12, 30),
            ("PCC-PRI017", "Android App Development", 16, 30),
            ("PCC-PRI018", "Java for Android", 14, 30),
            ("PCC-PRI019", "Kotlin for Android", 14, 30),
            ("PCC-PRI020", "Flutter Development", 16, 30),
            ("PCC-PRI021", "React Native Development", 16, 30),
            ("PCC-PRI022", "Android Studio Basics", 12, 30),
            ("PCC-PRI023", "Mobile UI/UX Design", 12, 30),
            ("PCC-PRI024", "RESTful API Integration", 14, 30),
            ("PCC-PRI025", "Firebase Integration", 12, 30),
            ("PCC-PRI026", "Artificial Intelligence", 12, 30),
            ("PCC-PRI027", "Machine Learning", 16, 30),
            ("PCC-PRI028", "Deep Learning", 18, 30),
            ("PCC-PRI029", "Neural Networks", 16, 30),
            ("PCC-PRI030", "Natural Language Processing (NLP)", 18, 30),
            ("PCC-PRI031", "Computer Vision", 16, 30),
            ("PCC-PRI032", "Data Science", 16, 30),
            ("PCC-PRI033", "Reinforcement Learning", 18, 30),
            ("PCC-PRI034", "Python", 12, 30),
            ("PCC-PRI035", "R Programming", 14, 30),
            ("PCC-PRI036", "TensorFlow", 16, 30),
            ("PCC-PRI037", "Keras", 16, 30),
            ("PCC-PRI038", "PyTorch", 16, 30),
            ("PCC-PRI039", "OpenCV", 14, 30),
            ("PCC-PRI040", "Scikit-learn", 14, 30),
            ("PCC-PRI041", "Pandas", 12, 30),
            ("PCC-PRI042", "NumPy", 12, 30),
            ("PCC-PRI043", "Matplotlib", 12, 30),
            ("PCC-PRI044", "ChatGPT", 12, 30),
            ("PCC-PRI045", "Large Language Models (LLM)", 18, 30),
            ("PCC-PRI046", "Edge AI", 16, 30),
            ("PCC-PRI047", "AI in Robotics", 18, 30),
            ("PCC-PRI048", "AI in IoT", 16, 30),
            ("PCC-PRI049", "AI Ethics", 14, 30),
            ("PCC-PRI050", "Explainable AI", 16, 30),
            ("PCC-PRI051", "AI Automation", 16, 30),
            ("PCC-PRI052", "Big Data Analytics", 18, 30),
            ("PCC-PRI053", "ML Algorithms Implementation", 18, 30),
            ("PCC-PRI054", "Face Recognition System", 16, 30),
            ("PCC-PRI055", "AI Chatbot Development", 14, 30),
            ("PCC-PRI056", "Spam Detection", 14, 30),
            ("PCC-PRI057", "Sentiment Analysis", 14, 30),
            ("PCC-PRI058", "Stock Price Prediction", 16, 30),
            ("PCC-PRI059", "Recommendation Systems", 16, 30),
            ("PCC-PRI060", "Object Detection", 16, 30),
            ("PCC-PRI061", "Speech Recognition", 16, 30),
            ("PCC-PRI062", "AI in Healthcare", 16, 30),
            ("PCC-PRI063", "AI in Education", 16, 30),
            ("PCC-PRI064", "AI in Cybersecurity", 18, 30),
            ("PCC-PRI065", "AI for Autonomous Vehicles", 18, 30),
            ("PCC-PRI066", "AI for Climate Change", 16, 30),
            ("PCC-PRI067", "AI and Quantum Computing", 18, 30),
            ("PCC-PRI068", "AI for Smart Cities", 16, 30),
            ("PCC-PRI069", "Human-AI Collaboration", 14, 30),
            ("PCC-PRI070", "AI Bias and Fairness", 14, 30),
            ("PCC-PRI071", "Federated Learning", 16, 30),
            ("PCC-PRI072", "Google Colab", 12, 30),
            ("PCC-PRI073", "Jupyter Notebook", 12, 30),
            ("PCC-PRI074", "Azure Machine Learning", 16, 30),
            ("PCC-PRI075", "AWS SageMaker", 16, 30),
            ("PCC-PRI076", "IBM Watson", 16, 30),
            ("PCC-PRI077", "MATLAB for AI", 14, 30),
            ("PCC-PRI078", "AutoML Tools", 16, 30),
            ("PCC-PRI079", "AI Model Deployment", 16, 30),
            ("PCC-PRI080", "Web Development", 12, 30),
            ("PCC-PRI081", "Data Science", 16, 30),
            ("PCC-PRI082", "Artificial Intelligence", 20, 30),
            ("PCC-PRI083", "Cloud Computing", 14, 30),
            ("PCC-PRI084", "Cyber Security", 18, 30),

            # ===== 44 ADDITIONAL NON-DUPLICATE COURSES =====
            ("PCC-ADD001", "Advanced Algorithms", 16, 25),
            ("PCC-ADD002", "Computer Graphics", 14, 20),
            ("PCC-ADD003", "Distributed Systems", 18, 30),
            ("PCC-ADD004", "Computer Vision", 16, 25),
            ("PCC-ADD005", "Embedded Systems", 14, 20),
            ("PCC-ADD006", "Wireless Networks", 12, 30),
            ("PCC-ADD007", "Database Administration", 16, 25),
            ("PCC-ADD008", "Software Architecture", 18, 20),
            ("PCC-ADD009", "Mobile Security", 14, 25),
            ("PCC-ADD010", "Ethical Hacking", 16, 30),
            ("PCC-ADD011", "Digital Forensics", 14, 20),
            ("PCC-ADD012", "Network Security", 16, 25),
            ("PCC-ADD013", "Cryptography", 18, 20),
            ("PCC-ADD014", "Penetration Testing", 14, 25),
            ("PCC-ADD015", "Secure Coding", 12, 30),
            ("PCC-ADD016", "Cloud Architecture", 16, 25),
            ("PCC-ADD017", "Serverless Computing", 14, 20),
            ("PCC-ADD018", "Microservices", 18, 25),
            ("PCC-ADD019", "Containerization", 16, 30),
            ("PCC-ADD020", "Data Mining", 14, 25),
            ("PCC-ADD021", "Data Visualization", 12, 30),
            ("PCC-ADD022", "Business Intelligence", 16, 25),
            ("PCC-ADD023", "Predictive Analytics", 18, 20),
            ("PCC-ADD024", "Time Series Analysis", 14, 25),
            ("PCC-ADD025", "Deep Learning", 16, 30),
            ("PCC-ADD026", "Reinforcement Learning", 18, 20),
            ("PCC-ADD027", "Computer Organization", 12, 30),
            ("PCC-ADD028", "Operating Systems", 16, 25),
            ("PCC-ADD029", "Compiler Design", 18, 20),
            ("PCC-ADD030", "Parallel Computing", 14, 25),
            ("PCC-ADD031", "Quantum Algorithms", 16, 30),
            ("PCC-ADD032", "Bioinformatics", 18, 20),
            ("PCC-ADD033", "Computational Biology", 14, 25),
            ("PCC-ADD034", "Health Informatics", 12, 30),
            ("PCC-ADD035", "Augmented Reality", 16, 25),
            ("PCC-ADD036", "Virtual Reality", 18, 20),
            ("PCC-ADD037", "Mixed Reality", 14, 25),
            ("PCC-ADD038", "Game Design", 16, 30),
            ("PCC-ADD039", "Game Physics", 18, 20),
            ("PCC-ADD040", "3D Modeling", 14, 25),
            ("PCC-ADD041", "Animation Techniques", 12, 30),
            ("PCC-ADD042", "Digital Signal Processing", 16, 25),
            ("PCC-ADD043", "Image Processing", 18, 20),
            ("PCC-ADD044", "Audio Processing", 14, 25)
        ]
...
def recommend_courses(course_name, num_recommendations=10, similarity_cutoff=0.60):
